...
export function configureFakeBackend() {
  ...
  window.fetch = function(url, opts) {
    ...
    // функция fetch будет возвращать промис с необходимыми нам параметрами
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        /**
         * если человек не авторизован вызываем функцию unauthories()
         * если его роль id не соответсвует id в в базе тоже unauthories()
         * если id соответствует - ok()
         */
        ...
        /**
         * если роль не соответсвует роли администратора - выкидываем unauthorised(), иначе ok()
         */
